...
classifier = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/LE13GK9BS/model.json',modelLoaded);
...
if(results[0].label=="goggles")
{
document.getElementById("update_emoji").innerHTML="&#128548"
}
if(results[0].label=="sparkling")
{
...
if(results[1].label=="goggles")
{
document.getElementById("update_emoji2").innerHTML="&#128548"
}
if(results[1].label=="sparkling")
{
